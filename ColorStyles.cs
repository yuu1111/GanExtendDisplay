...
namespace GanExtendDisplay
{
    ...
    {
        public static Color Color_Crude = new Color(0.44705883f, 0.21176471f, 0.21176471f);

        public static Color Color_Normal = new Color(0.4f, 0.4f, 0.4f);

        public static Color Color_Superior = new Color(0f, 0.6745098f, 1f);

        public static Color Color_Legendary = new Color(0.9137255f, 0.4745098f, 1f);

        public static Color Color_Mythical = new Color(1f, 0.89411765f, 0.3137255f);

        public static Color Color_Artifact = new Color(1f, 0.15686275f, 0.15686275f);
    }
